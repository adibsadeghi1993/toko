                      ...
                      <div className='card flex flex-col'>
                        <div className='py-5 px-4 border-b border-gray-100'>
                            <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
                                <h3 className='text-primary-color pr-3 font-bold text-otherCaption  text-center lg:text-right'>{ (!showEdit && !showPayment) && 'مشخصات بیمه گذار' } { (showEdit && !showPayment) && 'مشخصات بیمه شده' } {(!showEdit && showPayment) && 'اقساط'}</h3>
                                <div className=''>
