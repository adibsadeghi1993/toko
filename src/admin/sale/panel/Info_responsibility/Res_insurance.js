...
function Res_insurance( { setshow_info, ins_status } ) {
                ...
                <div className='pt-2 mt-5 px-4'>
                 ...
                 <input className='p-2 rounded border focus:outline-none focus:border-blue-400 mt-5 m-2' />
                    ...
                    <div>
                        ...
                        { (Submit_status == 'صادر شده' && nextbutton === 'صادر شد') && <button className={`px-4 py-2 border bg-gray-100 shadow m-3 rounded hover:bg-gray-200`} onClick={() => {setsubmit_status('اسکن')}} >صادر شده</button>}
