    ...
    return (
            ...
            <div className='flex justify-between mx-5'>
                <div>
                    ...
                    {nextbutton === 'لغو شد' && <button className={`px-4 py-2 border bg-gray-100 shadow m-3 rounded hover:bg-gray-200`} onClick={() => setshowSubmitModal(true)}>ثبت اسکن بیمه نامه</button>}
                    ...
                    { nextbutton !=='لغو شد' && (nextbutton !== 'پرداخت شده' && (insurance_status !== 'لغو شد' && !showSubmit))  &&  <button className={`px-4 py-2 border bg-gray-100 shadow m-3 rounded hover:bg-gray-200`} onClick={() => handlechange()}>{(nextbutton === undefined) ? 'انتطار تکمیل اطلاعات' :  nextbutton }</button>}
