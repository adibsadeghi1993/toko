    ...
    <>
      ...
      <div className="relative flex justify-center mt-5 p-1">
        <table className="w-11/12">
          <thead className="bg-gray-200">
            <tr>
              <th className="whitespace-nowrap border border-gray-300 px-2 ">
                تلفن همراه
              </th>
              <th className="whitespace-nowrap border border-gray-300 px-2 ">
                تلفن ثابت
              ...
              <th className="whitespace-nowrap border border-gray-300 px-2 py-2">
                ایمیل
              </th>
              <th className="whitespace-nowrap border border-gray-300 px-2 py-2">
                استان
      ...
      <textarea
        ...
        readonly="readonly"
        defaultValue={forms_info?.health_form}
      ></textarea>
      <div className="flex justify-between items-center mt-3">
      ...
      <textarea
        className="w-full mt-8 h-32 rounded border focus:outline-none focus:border-blue-400"
        readonly="readonly"
        defaultValue={forms_info?.insurance_records}
      ></textarea>
