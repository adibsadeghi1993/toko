...
function Products() {
  const { getProductCategories } = useContext(ProductContext);
  useEffect(() => {
        ...
        <div className="card flex flex-col min-h-screen">
          ...
          <div className="flex flex-wrap md:p-12 p-4 justify-center items-center ">
            <div className="w-64 m-3 shadow-lg border  rounded ">
              <img
                src="https://acp.tooko.co/img/theme/img-1-1000x600.jpg"
                className="rounded-t"
              />
              <div className="flex m-3">
                ...
                <button className="bg-gray-300 mr-auto hover:bg-gray-400 text-gray-800 font-bold py-1 px-3 rounded text-sm inline-flex items-center">
                  ویرایش
                </button>
              </div>
